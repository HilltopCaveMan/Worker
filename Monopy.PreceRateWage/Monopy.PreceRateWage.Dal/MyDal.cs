...
namespace Monopy.PreceRateWage.Dal
{
    public class MyDal
    {
        ...
        public static DataBase1GZD GetTotalDataBase1GZD(List<DataBase1GZD> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1GZD { Factory = "合计" } : new DataBase1GZD { Factory = "合计", RZBZ = list.Sum(t => string.IsNullOrEmpty(t.RZBZ) ? 0M : Convert.ToDecimal(t.RZBZ)).ToString(), BCBZ = list.Sum(t => string.IsNullOrEmpty(t.BCBZ) ? 0M : Convert.ToDecimal(t.BCBZ)).ToString(), JJGZ1 = list.Sum(t => string.IsNullOrEmpty(t.JJGZ1) ? 0M : Convert.ToDecimal(t.JJGZ1)).ToString(), JJGZ2 = list.Sum(t => string.IsNullOrEmpty(t.JJGZ2) ? 0M : Convert.ToDecimal(t.JJGZ2)).ToString(), JJGZ3 = list.Sum(t => string.IsNullOrEmpty(t.JJGZ3) ? 0M : Convert.ToDecimal(t.JJGZ3)).ToString(), JJGZ4 = list.Sum(t => string.IsNullOrEmpty(t.JJGZ4) ? 0M : Convert.ToDecimal(t.JJGZ4)).ToString(), KHGZ1 = list.Sum(t => string.IsNullOrEmpty(t.KHGZ1) ? 0M : Convert.ToDecimal(t.KHGZ1)).ToString(), KHGZ2 = list.Sum(t => string.IsNullOrEmpty(t.KHGZ2) ? 0M : Convert.ToDecimal(t.KHGZ2)).ToString(), KHGZ3 = list.Sum(t => string.IsNullOrEmpty(t.KHGZ3) ? 0M : Convert.ToDecimal(t.KHGZ3)).ToString(), KHGZ4 = list.Sum(t => string.IsNullOrEmpty(t.KHGZ4) ? 0M : Convert.ToDecimal(t.KHGZ4)).ToString(), FZYH = list.Sum(t => string.IsNullOrEmpty(t.FZYH) ? 0M : Convert.ToDecimal(t.FZYH)).ToString(), RG = list.Sum(t => string.IsNullOrEmpty(t.RG) ? 0M : Convert.ToDecimal(t.RG)).ToString(), SSBZ = list.Sum(t => string.IsNullOrEmpty(t.SSBZ) ? 0M : Convert.ToDecimal(t.SSBZ)).ToString(), PSBZ = list.Sum(t => string.IsNullOrEmpty(t.PSBZ) ? 0M : Convert.ToDecimal(t.PSBZ)).ToString(), CJJJ = list.Sum(t => string.IsNullOrEmpty(t.CJJJ) ? 0M : Convert.ToDecimal(t.CJJJ)).ToString(), CJFK = list.Sum(t => string.IsNullOrEmpty(t.CJFK) ? 0M : Convert.ToDecimal(t.CJFK)).ToString(), FLFK = list.Sum(t => string.IsNullOrEmpty(t.FLFK) ? 0M : Convert.ToDecimal(t.FLFK)).ToString(), PSFK = list.Sum(t => string.IsNullOrEmpty(t.PSFK) ? 0M : Convert.ToDecimal(t.PSFK)).ToString(), QTJX = list.Sum(t => string.IsNullOrEmpty(t.QTJX) ? 0M : Convert.ToDecimal(t.QTJX)).ToString(), QTJ = list.Sum(t => string.IsNullOrEmpty(t.QTJ) ? 0M : Convert.ToDecimal(t.QTJ)).ToString() };
        }

        public static DataBase2GZD GetTotalDataBase2GZD(List<DataBase2GZD> list)
        {
            return (list == null || list.Count == 0) ? new DataBase2GZD { Factory = "合计" } : new DataBase2GZD { Factory = "合计", RZBZ = list.Sum(t => string.IsNullOrEmpty(t.RZBZ) ? 0M : Convert.ToDecimal(t.RZBZ)).ToString(), BCBZ = list.Sum(t => string.IsNullOrEmpty(t.BCBZ) ? 0M : Convert.ToDecimal(t.BCBZ)).ToString(), JJGZ1 = list.Sum(t => string.IsNullOrEmpty(t.JJGZ1) ? 0M : Convert.ToDecimal(t.JJGZ1)).ToString(), JJGZ2 = list.Sum(t => string.IsNullOrEmpty(t.JJGZ2) ? 0M : Convert.ToDecimal(t.JJGZ2)).ToString(), JJGZ3 = list.Sum(t => string.IsNullOrEmpty(t.JJGZ3) ? 0M : Convert.ToDecimal(t.JJGZ3)).ToString(), JJGZ4 = list.Sum(t => string.IsNullOrEmpty(t.JJGZ4) ? 0M : Convert.ToDecimal(t.JJGZ4)).ToString(), KHGZ1 = list.Sum(t => string.IsNullOrEmpty(t.KHGZ1) ? 0M : Convert.ToDecimal(t.KHGZ1)).ToString(), KHGZ2 = list.Sum(t => string.IsNullOrEmpty(t.KHGZ2) ? 0M : Convert.ToDecimal(t.KHGZ2)).ToString(), KHGZ3 = list.Sum(t => string.IsNullOrEmpty(t.KHGZ3) ? 0M : Convert.ToDecimal(t.KHGZ3)).ToString(), KHGZ4 = list.Sum(t => string.IsNullOrEmpty(t.KHGZ4) ? 0M : Convert.ToDecimal(t.KHGZ4)).ToString(), FZYH = list.Sum(t => string.IsNullOrEmpty(t.FZYH) ? 0M : Convert.ToDecimal(t.FZYH)).ToString(), RG = list.Sum(t => string.IsNullOrEmpty(t.RG) ? 0M : Convert.ToDecimal(t.RG)).ToString(), SSBZ = list.Sum(t => string.IsNullOrEmpty(t.SSBZ) ? 0M : Convert.ToDecimal(t.SSBZ)).ToString(), PSBZ = list.Sum(t => string.IsNullOrEmpty(t.PSBZ) ? 0M : Convert.ToDecimal(t.PSBZ)).ToString(), CJJJ = list.Sum(t => string.IsNullOrEmpty(t.CJJJ) ? 0M : Convert.ToDecimal(t.CJJJ)).ToString(), CJFK = list.Sum(t => string.IsNullOrEmpty(t.CJFK) ? 0M : Convert.ToDecimal(t.CJFK)).ToString(), FLFK = list.Sum(t => string.IsNullOrEmpty(t.FLFK) ? 0M : Convert.ToDecimal(t.FLFK)).ToString(), PSFK = list.Sum(t => string.IsNullOrEmpty(t.PSFK) ? 0M : Convert.ToDecimal(t.PSFK)).ToString(), QTJX = list.Sum(t => string.IsNullOrEmpty(t.QTJX) ? 0M : Convert.ToDecimal(t.QTJX)).ToString(), QTJ = list.Sum(t => string.IsNullOrEmpty(t.QTJ) ? 0M : Convert.ToDecimal(t.QTJ)).ToString() };
        }
        ...
        {
            return (list == null || list.Count == 0) ? new DataBaseGeneral_XT { No = "合计", BZJE = 0.ToString() } : new DataBaseGeneral_XT { No = "合计", BZJE = list.Sum(t => decimal.TryParse(t.BZJE, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBaseGeneral_XT_CPLB GetTotalDataBaseGeneral_XT_CPLB(List<DataBaseGeneral_XT_CPLB> list)
        {
            return (list == null || list.Count == 0) ? new DataBaseGeneral_XT_CPLB { No = "合计", BZJE = 0.ToString() } : new DataBaseGeneral_XT_CPLB { No = "合计", BZJE = list.Sum(t => decimal.TryParse(t.BZJE, out decimal d) ? d : 0M).ToString() };
        }
        ...
        {
            return (list == null || list.Count == 0) ? new DataBase1MJ_DJCJYB { CPMC = "合计", SCLJ = 0.ToString(), BCLJ = 0.ToString(), PSLJ = 0.ToString() } : new DataBase1MJ_DJCJYB { CPMC = "合计", SCLJ = list.Sum(t => decimal.TryParse(t.SCLJ, out decimal result) ? result : 0M).ToString(), BCLJ = list.Sum(t => decimal.TryParse(t.BCLJ, out decimal result) ? result : 0M).ToString(), PSLJ = list.Sum(t => decimal.TryParse(t.PSLJ, out decimal result) ? result : 0M).ToString() };
        }
        ...
        {
            return (list == null || list.Count == 0) ? new DataBase1MJ_XJCJYB { CPMC = "合计", SCSL = 0.ToString() } : new DataBase1MJ_XJCJYB { CPMC = "合计", SCSL = list.Sum(t => decimal.TryParse(t.SCSL, out decimal result) ? result : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1SC_CJB GetTotalDataBase1SC_CJB(List<DataBase1SC_CJB> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1SC_CJB { No = "合计", GZ = "合计", ZYGDJJ = 0.ToString(), ZYGDKH = 0.ToString(), ZYGTBJJ = 0.ToString(), ZYGTBKH = 0.ToString(), BCKH = 0.ToString() } : new DataBase1SC_CJB { No = "合计", GZ = "合计", ZYGDJJ = list.Sum(t => decimal.TryParse(t.ZYGDJJ, out decimal d) ? d : 0M).ToString(), ZYGDKH = list.Sum(t => decimal.TryParse(t.ZYGDKH, out decimal d) ? d : 0M).ToString(), ZYGTBJJ = list.Sum(t => decimal.TryParse(t.ZYGTBJJ, out decimal d) ? d : 0M).ToString(), ZYGTBKH = list.Sum(t => decimal.TryParse(t.ZYGTBKH, out decimal d) ? d : 0M).ToString(), BCKH = list.Sum(t => decimal.TryParse(t.BCKH, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1PY_CJB GetTotalDataBase1PY_CJB(List<DataBase1PY_CJB> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1PY_CJB { No = "合计", LB = "合计", PYGSGKH = 0.ToString(), PYGSGJJ = 0.ToString(), PYGJXKH = 0.ToString(), PYGJXJJ = 0.ToString(), CSGSGKH = 0.ToString(), CSGSGJJ = 0.ToString(), CSGJJKH = 0.ToString(), CSGJXJJ = 0.ToString() } : new DataBase1PY_CJB { No = "合计", LB = "合计", PYGSGKH = list.Sum(t => decimal.TryParse(t.PYGSGKH, out decimal d) ? d : 0M).ToString(), PYGSGJJ = list.Sum(t => decimal.TryParse(t.PYGSGJJ, out decimal d) ? d : 0M).ToString(), PYGJXKH = list.Sum(t => decimal.TryParse(t.PYGJXKH, out decimal d) ? d : 0M).ToString(), PYGJXJJ = list.Sum(t => decimal.TryParse(t.PYGJXJJ, out decimal d) ? d : 0M).ToString(), CSGSGKH = list.Sum(t => decimal.TryParse(t.CSGSGKH, out decimal d) ? d : 0M).ToString(), CSGSGJJ = list.Sum(t => decimal.TryParse(t.CSGSGJJ, out decimal d) ? d : 0M).ToString(), CSGJJKH = list.Sum(t => decimal.TryParse(t.CSGJJKH, out decimal d) ? d : 0M).ToString(), CSGJXJJ = list.Sum(t => decimal.TryParse(t.CSGJXJJ, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1CX_XJBG GetTotalDataBase1CX_XJBG(List<DataBase1CX_XJBG> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1CX_XJBG { GW = "合计", SL = 0.ToString(), JE = 0.ToString() } : new DataBase1CX_XJBG { GW = "合计", SL = list.Sum(t => decimal.TryParse(t.SL, out decimal d) ? d : 0M).ToString(), JE = list.Sum(t => decimal.TryParse(t.JE, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1CX_FLJF GetTotalDataBase1CX_FLJF(List<DataBase1CX_FLJF> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1CX_FLJF { No = "合计", GH = "合计", FLFK = 0.ToString() } : new DataBase1CX_FLJF { No = "合计", GH = "合计", FLFK = list.Sum(t => decimal.TryParse(t.FLFK, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1CX_QTJJ GetTotalDataBase1CX_QTJJ(List<DataBase1CX_QTJJ> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1CX_QTJJ { GW = "合计", JS = 0.ToString(), JE = 0.ToString() } : new DataBase1CX_QTJJ { GW = "合计", JS = list.Sum(t => decimal.TryParse(t.JS, out decimal d) ? d : 0M).ToString(), JE = list.Sum(t => decimal.TryParse(t.JE, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1CX_General_CXYB GetTotalDataBase1CX_General_CXYB(List<DataBase1CX_General_CXYB> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1CX_General_CXYB { No = "合计", CPBM = "合计", KYL = 0.ToString(), YJP = 0.ToString(), YJL = 0.ToString(), QX01 = 0.ToString(), QX02 = 0.ToString(), QX03 = 0.ToString(), QX04 = 0.ToString(), QX05 = 0.ToString(), QX06 = 0.ToString(), QX07 = 0.ToString(), QX08 = 0.ToString(), QX09 = 0.ToString(), QX10 = 0.ToString(), QX11 = 0.ToString(), QX12 = 0.ToString(), QX13 = 0.ToString(), QX14 = 0.ToString(), JJ = 0.ToString(), PS = 0.ToString() } : new DataBase1CX_General_CXYB { No = "合计", CPBM = "合计", KYL = list.Sum(t => decimal.TryParse(t.KYL, out decimal d) ? d : 0M).ToString(), YJP = list.Sum(t => decimal.TryParse(t.YJP, out decimal d) ? d : 0M).ToString(), YJL = list.Sum(t => decimal.TryParse(t.YJL, out decimal d) ? d : 0M).ToString(), QX01 = list.Sum(t => decimal.TryParse(t.QX01, out decimal d) ? d : 0M).ToString(), QX02 = list.Sum(t => decimal.TryParse(t.QX02, out decimal d) ? d : 0M).ToString(), QX03 = list.Sum(t => decimal.TryParse(t.QX03, out decimal d) ? d : 0M).ToString(), QX04 = list.Sum(t => decimal.TryParse(t.QX04, out decimal d) ? d : 0M).ToString(), QX05 = list.Sum(t => decimal.TryParse(t.QX05, out decimal d) ? d : 0M).ToString(), QX06 = list.Sum(t => decimal.TryParse(t.QX06, out decimal d) ? d : 0M).ToString(), QX07 = list.Sum(t => decimal.TryParse(t.QX07, out decimal d) ? d : 0M).ToString(), QX08 = list.Sum(t => decimal.TryParse(t.QX08, out decimal d) ? d : 0M).ToString(), QX09 = list.Sum(t => decimal.TryParse(t.QX09, out decimal d) ? d : 0M).ToString(), QX10 = list.Sum(t => decimal.TryParse(t.QX10, out decimal d) ? d : 0M).ToString(), QX11 = list.Sum(t => decimal.TryParse(t.QX11, out decimal d) ? d : 0M).ToString(), QX12 = list.Sum(t => decimal.TryParse(t.QX12, out decimal d) ? d : 0M).ToString(), QX13 = list.Sum(t => decimal.TryParse(t.QX13, out decimal d) ? d : 0M).ToString(), QX14 = list.Sum(t => decimal.TryParse(t.QX14, out decimal d) ? d : 0M).ToString(), JJ = list.Sum(t => decimal.TryParse(t.JJ, out decimal d) ? d : 0M).ToString(), PS = list.Sum(t => decimal.TryParse(t.PS, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1CX_CX_02JJKHTB GetTotalDataBase1CX_CX_02JJKHTB(List<DataBase1CX_CX_02JJKHTB> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1CX_CX_02JJKHTB { No = "合计", GD = "合计", MXS = 0.ToString(), ZJCS = 0.ToString(), MXS2 = 0.ToString(), ZJCS2 = 0.ToString() } : new DataBase1CX_CX_02JJKHTB { No = "合计", GD = "合计", MXS = list.Sum(t => decimal.TryParse(t.MXS, out decimal d) ? d : 0M).ToString(), ZJCS = list.Sum(t => decimal.TryParse(t.ZJCS, out decimal d) ? d : 0M).ToString(), MXS2 = list.Sum(t => decimal.TryParse(t.MXS2, out decimal d) ? d : 0M).ToString(), ZJCS2 = list.Sum(t => decimal.TryParse(t.ZJCS2, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1CX_BCBZ GetTotalDataBase1CX_BCBZ(List<DataBase1CX_BCBZ> list)
        {
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase1CX_CX_06JJ_GR GetTotalDataBase1CX_CX_06JJ_GR(List<DataBase1CX_CX_06JJ_GR> list)
        {
            return (list == null || list.Count == 0) ? new DataBase1CX_CX_06JJ_GR { No = "合计", BZBM = "合计", KHGZ = 0.ToString(), JJGZ = 0.ToString(), KHGZGR = 0.ToString(), JJGZGR = 0.ToString(), GRHJ = 0.ToString() } : new DataBase1CX_CX_06JJ_GR { No = "合计", BZBM = "合计", KHGZ = list.Sum(t => decimal.TryParse(t.KHGZ, out decimal d) ? d : 0M).ToString(), JJGZ = list.Sum(t => decimal.TryParse(t.JJGZ, out decimal d) ? d : 0M).ToString(), KHGZGR = list.Sum(t => decimal.TryParse(t.KHGZGR, out decimal d) ? d : 0M).ToString(), JJGZGR = list.Sum(t => decimal.TryParse(t.JJGZGR, out decimal d) ? d : 0M).ToString(), GRHJ = list.Sum(t => decimal.TryParse(t.GRHJ, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase2CX_QTJJ GetTotalDataBase2CX_QTJJ(List<DataBase2CX_QTJJ> list)
        {
            return (list == null || list.Count == 0) ? new DataBase2CX_QTJJ { GW = "合计", JS = 0.ToString(), JE = 0.ToString() } : new DataBase2CX_QTJJ { GW = "合计", JS = list.Sum(t => decimal.TryParse(t.JS, out decimal d) ? d : 0M).ToString(), JE = list.Sum(t => decimal.TryParse(t.JE, out decimal d) ? d : 0M).ToString() };
        }
        ...
        {
            return (list == null || list.Count == 0) ? new DataBase2JB_BZCQ { No = "合计", CQTS = 0.ToString(), GRJJ = 0.ToString() } : new DataBase2JB_BZCQ { No = "合计", CQTS = list.Sum(t => decimal.TryParse(t.CQTS, out decimal d) ? d : 0M).ToString(), GRJJ = list.Sum(t => decimal.TryParse(t.GRJJ, out decimal d) ? d : 0M).ToString() };
        }
        ...
        {
            return (list == null || list.Count == 0) ? new DataBase2JB_ZZJJ { No = "合计", SL = 0.ToString(), HJ = 0.ToString(),JJJE=0.ToString() } : new DataBase2JB_ZZJJ { No = "合计", SL = list.Sum(t => decimal.TryParse(t.SL, out decimal d) ? d : 0M).ToString(), HJ = list.Sum(t => decimal.TryParse(t.HJ, out decimal d) ? d : 0M).ToString(), JJJE = list.Sum(t => decimal.TryParse(t.JJJE, out decimal d) ? d : 0M).ToString() };
        }
        ...
        {
            return (list == null || list.Count == 0) ? new DataBase2JB_ZZCQ { No = "合计", CQTS = 0.ToString(),GRJJ=0.ToString() } : new DataBase2JB_ZZCQ { No = "合计", CQTS = list.Sum(t => decimal.TryParse(t.CQTS, out decimal d) ? d : 0M).ToString(), GRJJ = list.Sum(t => decimal.TryParse(t.GRJJ, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase2CX_BCBZ GetTotalDataBase2CX_BCBZ(List<DataBase2CX_BCBZ> list)
        {
            return (list == null || list.Count == 0) ? new DataBase2CX_BCBZ { No = "合计", GD = "合计", BZJE = 0.ToString() } : new DataBase2CX_BCBZ { No = "合计", GD = "合计", BZJE = list.Sum(t => decimal.TryParse(t.BZJE, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase2CX_CX_01CXYB GetTotalDataBase2CX_CX_01CXYB(List<DataBase2CX_CX_01CXYB> list)
        {
            return (list == null || list.Count == 0) ? new DataBase2CX_CX_01CXYB { No = "合计", CPBM = "合计", KYL = 0.ToString(), YJP = 0.ToString(), YJL = 0.ToString(), QX01 = 0.ToString(), QX02 = 0.ToString(), QX03 = 0.ToString(), QX04 = 0.ToString(), QX05 = 0.ToString(), QX06 = 0.ToString(), QX07 = 0.ToString(), QX08 = 0.ToString(), QX09 = 0.ToString(), QX10 = 0.ToString(), QX11 = 0.ToString(), QX12 = 0.ToString(), QX13 = 0.ToString(), QX14 = 0.ToString(), JJ = 0.ToString(), PS = 0.ToString() } : new DataBase2CX_CX_01CXYB { No = "合计", CPBM = "合计", KYL = list.Sum(t => decimal.TryParse(t.KYL, out decimal d) ? d : 0M).ToString(), YJP = list.Sum(t => decimal.TryParse(t.YJP, out decimal d) ? d : 0M).ToString(), YJL = list.Sum(t => decimal.TryParse(t.YJL, out decimal d) ? d : 0M).ToString(), QX01 = list.Sum(t => decimal.TryParse(t.QX01, out decimal d) ? d : 0M).ToString(), QX02 = list.Sum(t => decimal.TryParse(t.QX02, out decimal d) ? d : 0M).ToString(), QX03 = list.Sum(t => decimal.TryParse(t.QX03, out decimal d) ? d : 0M).ToString(), QX04 = list.Sum(t => decimal.TryParse(t.QX04, out decimal d) ? d : 0M).ToString(), QX05 = list.Sum(t => decimal.TryParse(t.QX05, out decimal d) ? d : 0M).ToString(), QX06 = list.Sum(t => decimal.TryParse(t.QX06, out decimal d) ? d : 0M).ToString(), QX07 = list.Sum(t => decimal.TryParse(t.QX07, out decimal d) ? d : 0M).ToString(), QX08 = list.Sum(t => decimal.TryParse(t.QX08, out decimal d) ? d : 0M).ToString(), QX09 = list.Sum(t => decimal.TryParse(t.QX09, out decimal d) ? d : 0M).ToString(), QX10 = list.Sum(t => decimal.TryParse(t.QX10, out decimal d) ? d : 0M).ToString(), QX11 = list.Sum(t => decimal.TryParse(t.QX11, out decimal d) ? d : 0M).ToString(), QX12 = list.Sum(t => decimal.TryParse(t.QX12, out decimal d) ? d : 0M).ToString(), QX13 = list.Sum(t => decimal.TryParse(t.QX13, out decimal d) ? d : 0M).ToString(), QX14 = list.Sum(t => decimal.TryParse(t.QX14, out decimal d) ? d : 0M).ToString(), JJ = list.Sum(t => decimal.TryParse(t.JJ, out decimal d) ? d : 0M).ToString(), PS = list.Sum(t => decimal.TryParse(t.PS, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase2CX_CX_02JJKHTB GetTotalDataBase2CX_CX_02JJKHTB(List<DataBase2CX_CX_02JJKHTB> list)
        {
            return (list == null || list.Count == 0) ? new DataBase2CX_CX_02JJKHTB { No = "合计", GD = "合计", MXS = 0.ToString(), ZJCS = 0.ToString(), MXS2 = 0.ToString(), ZJCS2 = 0.ToString() } : new DataBase2CX_CX_02JJKHTB { No = "合计", GD = "合计", MXS = list.Sum(t => decimal.TryParse(t.MXS, out decimal d) ? d : 0M).ToString(), ZJCS = list.Sum(t => decimal.TryParse(t.ZJCS, out decimal d) ? d : 0M).ToString(), MXS2 = list.Sum(t => decimal.TryParse(t.MXS2, out decimal d) ? d : 0M).ToString(), ZJCS2 = list.Sum(t => decimal.TryParse(t.ZJCS2, out decimal d) ? d : 0M).ToString() };
        }
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataBase2CX_CX_06JJ_GR GetTotalDataBase2CX_CX_06JJ_GR(List<DataBase2CX_CX_06JJ_GR> list)
        {
            return (list == null || list.Count == 0) ? new DataBase2CX_CX_06JJ_GR { No = "合计", BZBM = "合计", CLKH = 0.ToString(), ZLKH = 0.ToString(), JJGZ = 0.ToString(), CLKHGR = 0.ToString(), ZLKHGR = 0.ToString(), JJGZGR = 0.ToString(), GRHJ = 0.ToString() } : new DataBase2CX_CX_06JJ_GR { No = "合计", BZBM = "合计", CLKH = list.Sum(t => decimal.TryParse(t.CLKH, out decimal d) ? d : 0M).ToString(), ZLKH = list.Sum(t => decimal.TryParse(t.ZLKH, out decimal d) ? d : 0M).ToString(), JJGZ = list.Sum(t => decimal.TryParse(t.JJGZ, out decimal d) ? d : 0M).ToString(), CLKHGR = list.Sum(t => decimal.TryParse(t.CLKHGR, out decimal d) ? d : 0M).ToString(), ZLKHGR = list.Sum(t => decimal.TryParse(t.ZLKHGR, out decimal d) ? d : 0M).ToString(), JJGZGR = list.Sum(t => decimal.TryParse(t.JJGZGR, out decimal d) ? d : 0M).ToString(), GRHJ = list.Sum(t => decimal.TryParse(t.GRHJ, out decimal d) ? d : 0M).ToString() };
        }
