...
namespace Monopy.PreceRateWage.Common
{
    public static class StringHelper
    {
        ...
        /// <summary>
        /// 保留2位小数
        /// Math.Round(Decimal,2)方法有时候返回结果不正确。
        /// </summary>
        /// <param name="Decimal">原小数</param>
        /// <returns>保留2位小数的结果</returns>
        public static double ToRetainTwoDecimalPlaces(double Decimal)
        {
            return Convert.ToDouble(string.Format("{0:F}", Decimal));
        }
        ...
        /// <returns></returns>
        public static int GetChineseLength(string ChineseStr)
        {
            int intLen = ChineseStr.Length;
            int i;
        ...
        /// 截取取中文字符
        /// </summary>
        /// <param name="ChineseStr">原中文字符</param>
        /// <param name="Length">保留多少位</param>
        /// <param name="AfterStr">截取后剩余的字符</param>
        /// <returns></returns>
        public static string GetChineseString(string ChineseStr, int Length, ref string AfterStr)
        {
            int intLen = ChineseStr.Length;
            int start = 0;
            int end = intLen;
            ...
            string temp = ChineseStr.Substring(0, end);
            string temp2 = ChineseStr.Remove(0, end);
            AfterStr = temp2;
            return temp;
        }
        ...
        public static string Encode(string strEncode)
        {
            ...
            //for (int i = strReturn.Length; i < 32; i++)
            //{
            //    strReturn += "0000";
            //}
            return strReturn;
        ...
        public static string GetChineseSpell(string strText)
        {
            if (strText == null || strText.Length == 0)
                return strText;
            strText = Regex.Replace(strText, @"[^\w-.+]", "");  // 保留+-_.符号
        ...
        /// <param name="ws"></param>
        /// <returns></returns>
        public static string xy(string strxy, int ws)
        {
            decimal d = Convert.ToDecimal(strxy);
            string a = Math.Round(d, 1).ToString();
            return a;
        }
