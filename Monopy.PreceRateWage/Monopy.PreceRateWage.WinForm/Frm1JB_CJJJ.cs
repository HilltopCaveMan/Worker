                    ...
                    using (FileStream fs = new FileStream(openFileDlg.FileName, FileMode.Open, FileAccess.Read))
                    {
                        ...
                        for (int i = 3; i <= sheet.LastRowNum; i++)
                        {
                            ...
                            else
                            {
                                ...
                                var ltg_lt = new DataBase1JB_CJJJ_Result { Id = Guid.NewGuid(), Name = "连体盖-连体", Price = 0, Money = 0, TheCount = (ltg == null ? 0 : ltg.TheCount) - (lt == null ? 0 : lt.TheCount) };
                                ...
                                var sxhgl = new DataBase1JB_CJJJ_Result { Id = Guid.NewGuid(), Name = "水箱含盖类", Price = hh == null ? 0 : Convert.ToDouble(hh.UnitPrice), TheCount = ((sxl == null ? 0 : sxl.TheCount) + (g == null ? 0 : g.TheCount) + (ltg_lt == null ? 0 : ltg_lt.TheCount)) / 2 };
