...
{
    public partial class Frm2JB_HS : Office2007Form
    {
        ...
        /// <param name="e"></param>
        private void Frm2JB_HS_Load(object sender, EventArgs e)
        {
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            DataBase2JB_ZY DataBase2JB_ZY = new DataBase2JB_ZY() { Id = Guid.NewGuid(), CreateTime = Program.NowTime, CreateUser = Program.User.ToString(), TheYear = dtp.Value.Year, TheMonth = dtp.Value.Month, No = maxNo.ToString(), TheType = 2 };
        ...
        private void RefDgv(DateTime selectTime, string cpmc)
        {
            ...
            var datas = new BaseDal<DataBase2JB_ZY>().GetList(t => t.TheType == 2 && t.TheYear == selectTime.Year && t.TheMonth == selectTime.Month && t.CPMC.Contains(cpmc)).ToList().OrderBy(t => int.TryParse(t.No, out int no) ? no : int.MaxValue).ToList();
            dgv.DataSource = null;
